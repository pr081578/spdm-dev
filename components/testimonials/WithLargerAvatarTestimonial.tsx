...
function WithLargerAvatarTestimonial({ testimonial }: TestimonialProps) {
  return (
            ...
            <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
              ...
              <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
                <Image
                  ...
                  width={testimonial.image.width} //recommended 270
                  height={testimonial.image.height} //recommended 270
                />
              </div>
...
export { WithLargerAvatarTestimonial };
